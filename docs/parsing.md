# ЧАВо по синтаксическому и грамматическому разбору
...
самодостаточны, и являются "дешёвым и сердитым" введением в задачу грамматического разбора, чтобы понимать
